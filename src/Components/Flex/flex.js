        ...
        <div className="py-5">
          <div className="container--tab position-relative">
            <h1
              ...
              onClick={(prevState) => {
                setResourceType((prevState) => !prevState);
              }}
              style={{ cursor: "pointer" }}
            >
              {!titleName ? <p>Loading...</p> : props.title}
            </h1>
            <div className="content d-flex align-items-center flex-wrap-reverse">
              ...
              <div className="">
                <img
                  className="d-block d-md-none img-fluid pt-3"
                  src={editorMobile}
                  alt="tabMob"
                />
                <img
                  className="d-none d-md-block position-absolute start-25 top-0 pb-5"
                  src={props.image}
                  alt="tab"
                />
              </div>
          ...
          <div className="container--tab position-relative">
            ...
            <div className="content2 d-flex align-items-center flex-wrap-reverse">
              ...
              <div className="">
                ...
                />
                <img
                  className="d-none d-md-block position-absolute end-50 top-0 pt-5"
                  src={props.image}
                  alt="tab"
                />
              </div>
